...
// Define this to set a unique identifier for this printer, (Used bysome programs to differentiate between machines)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,99}  // default steps per unit for ultimaker {78.7402,78.7402,200*8/3,760*1.1}920
...
//automatic expansion
 ...
 #define ULTIPANEL
 #define NEWPANEL
 #define DEFAULT_LCD_CONTRAST 64
#endif
